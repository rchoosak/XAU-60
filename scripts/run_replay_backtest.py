#!/usr/bin/env python3
"""
Replay backtest runner (live-like).
...
def _prepare_bot(
    ...
    if not enabled:
        ...
        raise RuntimeError(
            ...
            "in replay_backtest.yaml, or pass --strategy/--strategies. "
...
def _print_result(result: Dict[str, Any]) -> None:
    print("\n" + "=" * 40)
    print(f" REPLAY BACKTEST: {result['symbol']}")
    print("=" * 40)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Replay backtest runner (live-like)")
    parser.add_argument("-f", "--config", default="config/replay_backtest.yaml", help="Path to backtest config")
