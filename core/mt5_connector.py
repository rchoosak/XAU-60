...
class MT5Connector:
    ...
    _TIMEFRAME_H2 = getattr(mt5, "TIMEFRAME_H2", None)
    TIMEFRAMES = {
        "M1": mt5.TIMEFRAME_M1,
        "M5": mt5.TIMEFRAME_M5,
    ...
    if _TIMEFRAME_H2 is not None:
        TIMEFRAMES["H2"] = _TIMEFRAME_H2
    ...
    def get_ohlcv(
        ...
        Args:
            symbol: Symbol name
            timeframe: Timeframe string (S1, M1, M5, M15, M30, H1, H2, H4, D1, W1, MN1)
